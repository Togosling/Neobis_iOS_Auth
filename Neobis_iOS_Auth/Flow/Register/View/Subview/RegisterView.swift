...
class RegisterView: BaseView {
    ...
    let registerLabel: UILabel = {
        ...
        label.attributedText = NSMutableAttributedString(string: "Регистрация", attributes: [NSAttributedString.Key.kern: -0.41, NSAttributedString.Key.paragraphStyle: paragraphStyle])
        return label
    }()
